...
The challenge is to create the Huddle Landing Page, a modern and responsive landing page for the Huddle website. Users should be able to view the optimal layout for the site depending on their device's screen size and see hover states for all interactive elements on the page.
...
1. Clone the repository using GitHub Desktop or Git Bash:
   ```bash
   git clone https://github.com/SartHak-0-Sach/Huddle-landing-page_frontend_project.git
   ```
...
- Solution URL: [GitHub Repository](https://github.com/SartHak-0-Sach/Huddle-landing-page_frontend_project)
- Live Site URL: [Live Site](https://huddle-landing-page-frontend-app.netlify.app/)
